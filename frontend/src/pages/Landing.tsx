  ...
  return (
    <div className="bg-bg-deep text-ink-mid min-h-screen font-body selection:bg-accent-dim selection:text-accent">
      ...
      <nav className="flex items-center justify-between px-6 md:px-10 py-6 border-b border-hairline bg-bg-panel">
        ...
        <Link to="/dashboard" className="font-body text-sm font-semibold bg-accent text-bg-deep rounded-full px-5 py-2 hover:opacity-90 transition-opacity">
          Launch Demo
        </Link>
      </nav>
      ...
      <section className="px-6 md:px-10 pt-20 pb-8 reveal max-w-5xl mx-auto text-center">
        ...
        <div className="mt-10">
          <Link to="/dashboard" className="inline-block font-body font-semibold text-lg bg-accent text-bg-deep rounded-full px-8 py-3 hover:opacity-90 transition-all shadow-[0_0_15px_rgba(255,107,74,0.3)] hover:shadow-[0_0_25px_rgba(255,107,74,0.5)]">
